        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center space-x-4" x-data="authButtons">
                ...
                <div id="auth-user" class="flex items-center space-x-4 hidden">
                    ...
                    <a href="/acp" x-show="$store.auth.isAdmin()" class="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-amber-500 to-orange-600 px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:from-amber-600 hover:to-orange-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 shadow-md hover:shadow-lg cursor-pointer">
            ...
            <div class="space-y-1 pb-3 pt-2">
                ...
                <div class="border-t border-zinc-200 pt-2 mt-2" x-data="authButtons">
                    ...
                    <div id="mobile-auth-user" class="hidden">
                        ...
                        <a href="/acp" x-show="$store.auth.isAdmin()" class="flex items-center border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-zinc-700 hover:border-amber-300 hover:bg-amber-50 hover:text-amber-900 transition-colors duration-200">
