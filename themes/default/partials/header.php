        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex-shrink-0">
                <a href="/" class="flex items-center space-x-2">
                    <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-xl text-white font-semibold">
                        <svg class="w-6 h-6" viewBox="0 0 337.5 337.5" xmlns="http://www.w3.org/2000/svg">
