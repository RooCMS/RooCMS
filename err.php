...
switch($status_code) {
    case 400:
        $error = '400: Bad request. Please check the request and try again.';
        break;
    case 401:
        $error = '401: Unauthorized. Please check your credentials and try again.';
        break;
    case 403:
        $error = '403: Access denied. Please check your credentials and try again.';
        break;
    case 404:
        $error = '404: Page not found. Please check the URL and try again.';
        break;
    case 405:
        $error = '405: Method not allowed. Please check the request method and try again.';
        break;
    case 408:
        $error = '408: Request timeout. Please try again later.';
        break;
    case 409:
        $error = '409: Conflict. Please try again later.';
        break;
    case 414:
        $error = '414: URI too long. Please check the URL and try again.';
        break;
    case 500:
