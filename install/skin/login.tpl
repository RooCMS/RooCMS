...
#or {width: 100%;height: 200px;position:relative;z-index: 4;background-color: #fffff9;left: 0px;top: -100px;vertical-align: top;text-align: left;border: 0px;background: url('skin/acp/img/bg_loginform_normal.png') repeat;}
#er {width: 100%;height: 200px;position:relative;z-index: 4;background-color: #fffff9;left: 0px;top: -100px;vertical-align: top;text-align: left;border: 0px;background: url('skin/acp/img/bg_loginform_error.png') repeat;}
