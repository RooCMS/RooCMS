...
$sql['INSERT '.CONFIG_TABLE." ID #".$id] = "INSERT INTO `".CONFIG_TABLE."` (`id`, `part`, `sort`, `title`, `description`, `option_name`, `option_type`, `variants`, `value`, `default`)
											VALUES (".$id.", 'rss', 1, 'Вкл/Выкл RSS лент', 'Опция глобального включения или отключения RSS лент', 'rss_power', 'boolean', '', 'true', 'true')"; $id++;
$sql['INSERT '.CONFIG_TABLE." ID #".$id] = "INSERT INTO `".CONFIG_TABLE."` (`id`, `part`, `sort`, `title`, `description`, `option_name`, `option_type`, `variants`, `value`, `default`)
											VALUES (".$id.", 'rss', 2, 'TTL', 'Время жизни фида в секундах', 'rss_ttl', 'int', '', '240', '240')"; $id++;
...
$id = 1;
$sql['INSERT '.HELP_TABLE." ID #".$id] = "INSERT INTO `".HELP_TABLE."` (`id`, `uname`, `parent_id`, `sort`, `childs`, `title`, `content`, `date_modified`)
