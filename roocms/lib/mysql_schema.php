...
$sql['INSERT '.HELP_TABLE." ID #03"] = "INSERT INTO `".HELP_TABLE."` VALUES(3, 'acp', 1, 1, 2, 'Панель управления сайтом', '&lt;p&gt;В данном разделе собрана информация по управлению сайтом через Панель Администратора.&lt;/p&gt;\r\n\r\n&lt;p&gt;Для получения более подробной справки смотрите подразделы указанный ниже.&lt;/p&gt;\r\n', 1381439635)";
...
$sql['INSERT '.HELP_TABLE." ID #05"] = "INSERT INTO `".HELP_TABLE."` VALUES(7, 'userui', 1, 0, 1, 'Пользовательская часть сайта', '&lt;p&gt;В данном разделе содержится информации о пользовательской части сайта и работе с ней.&lt;/p&gt;\r\n\r\n&lt;p&gt;В подразделах ниже, вы найдете всю необходимую информацию.&lt;/p&gt;\r\n', 1381388640)";
