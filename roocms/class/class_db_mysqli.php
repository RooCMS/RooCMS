	...
	*/
	public function __construct() {
		...
		if(trim($db_info['host']) != "" && trim($db_info['base']) != "") {
			$this->connect($db_info['host'], $db_info['user'], $db_info['pass'], $db_info['base'], $db_info['port'] ?? 3306);
		}
	}
	 ...
	 * @return boolean
	 */
	public function check_connect(string $host, string $user, string $pass, string $base, int $port = 3306) {
