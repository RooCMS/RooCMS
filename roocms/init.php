...
spl_autoload_register(function(string $class_name) {
    ...
    $allowed_classes = [
        ...
        'Themes'                    => _MODULES . '/class_themes.php',
        'ThemeConfig'               => _MODULES . '/class_themeConfig.php',
        'TemplateRenderer'          => _MODULES . '/interface_templateRenderer.php',
        'ThemeConfigInterface'      => _MODULES . '/interface_themeConfig.php',
        'TemplateRendererPhp'       => _MODULES . '/class_templateRendererPhp.php',
        'TemplateRendererHtml'      => _MODULES . '/class_templateRendererHtml.php',
        ...
        'DependencyContainer'       => _MODULES . '/class_dependencyContainer.php',
        'ControllerFactory'         => _MODULES . '/interface_controllerFactory.php',
        'DefaultControllerFactory'  => _MODULES . '/class_defaultControllerFactory.php',
        'MiddlewareFactory'         => _MODULES . '/interface_middlewareFactory.php',
        'DefaultMiddlewareFactory'  => _MODULES . '/class_defaultMiddlewareFactory.php',
