...
<body>
	<div class="container">
		...
		<div class="jumbotron">
			...
			<p class="lead">Ведутся пуско-наладочные работы.</p>

		</div>

		<p class="well well-sm small">
		Это не продлится долго. Попробуйте <a href="#" onclick="window.location = window.location;">обновить страницу</a> через 3-5 минут.
		<br />Возможно, что обновляется только данный раздел, попробуйте вернуться на <a href="/">главную страницу</a> сайта.
		<br />Вы так же можете <a href="javascript:history.back(1)">вернуться</a> на страницу с которой сюда попали.
		</p>
