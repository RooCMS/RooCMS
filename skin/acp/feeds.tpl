...
<div class="col-md-2">
	...
	{*<ul class="nav nav-list">*}
		...
		{if isset($smarty.get.part) && ($smarty.get.part == 'control' || $smarty.get.part == 'edit_item' || $smarty.get.part == 'settings' || $smarty.get.part == 'create_item')}
			<li{if isset($smarty.get.part) && $smarty.get.part == "create_item"} class="active"{/if}><a href="{$SCRIPT_NAME}?act=feeds&part=create_item&page={$smarty.get.page}"><span class="fa fa-fw fa-volume-up"></span> Создать новый элемент ленты</a></li>
            ...
            {if isset($smarty.get.part) && ($smarty.get.part != 'edit_item' && $smarty.get.part != 'settings' && $smarty.get.part != 'create_item')}
				...
				<li><a href="{$SCRIPT_NAME}?act=feeds"><span class="fa fa-fw fa-arrow-left"></span>  Вернуться ко всем лентам</a></li>
			{/if}
		{else}
