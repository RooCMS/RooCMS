...
<div class="col-md-2">
	<ul class="nav nav-pills nav-stacked">
		...
		<li{if isset($smarty.get.part) && $smarty.get.part == "group_list"} class="active"{/if}><a href="{$SCRIPT_NAME}?act=users&part=group_list"><span class="fa fa-fw fa-users"></span> Список групп</a></li>
