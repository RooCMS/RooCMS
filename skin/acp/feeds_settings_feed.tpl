			...
			<div class="col-lg-9">
				<div class="btn-group roocms-boolui" data-toggle="buttons">
					<label class="btn btn-default{if $feed['rss']} active{/if}">
						<input type="radio" name="rss" value="1" id="flag_rss_on"{if $feed['rss']} checked{/if}> <span class="text-success"><i class="fa fa-fw fa-fa-check-square-o"></i> Вкл</span>
					</label>
					<label class="btn btn-default{if !$feed['rss']} active{/if}">
						<input type="radio" name="rss" value="0" id="flag_rss_off"{if !$feed['rss']} checked{/if}> <span class="text-danger"><i class="fa fa-fw fa-square-o"></i> Выкл</span>
					</label>
				</div>
