...
<div class="card-body">
	<div class="form-group row">
		<label for="inputRss" class="col-md-4 form-control-plaintext text-right">
	...
	<div class="form-group row">
		<label for="inputShowChildFeeds" class="col-md-4 form-control-plaintext text-right">
			Показ публикаций:
	...
	<div class="form-group row">
		<label for="inputItems" class="col-md-4 form-control-plaintext text-right">
	...
	<div class="form-group row">
		<label for="inputItemsSorting" class="col-md-4 form-control-plaintext text-right">
	...
	{* Миниаютры *}
	<div class="form-group row">
		<label for="inputAppendInfoBefore" class="col-md-4 form-control-plaintext text-right">
	...
	<div class="form-group row">
		<label for="inputAppendInfoAfter" class="col-md-4 form-control-plaintext text-right">
