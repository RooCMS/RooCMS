			...
			<div class="col-lg-9">
				<div class="btn-group" data-toggle="buttons">
					<label class="btn btn-default{if $feed['rss'] == 1} active{/if}">
						<input type="radio" name="rss" value="1" id="flag_rss_on"{if $feed['rss'] == 1} checked{/if}> <span class="text-success">Вкл</span>
					</label>
					<label class="btn btn-default{if $feed['rss'] == 0} active{/if}">
						<input type="radio" name="rss" value="0" id="flag_rss_off"{if $feed['rss'] == 0} checked{/if}> <span class="text-danger">Выкл</span>
					</label>
				</div>
