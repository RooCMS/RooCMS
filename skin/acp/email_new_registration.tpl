...
Администрация сайта <a href="{$site['domain']}" target="_blank">{$site['title']}</a> создала для вас приватную учетную запись, которой вы можете пользоваться для получения персонального доступа к сайту.
