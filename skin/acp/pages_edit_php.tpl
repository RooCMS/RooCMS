...
<div class="panel-heading">
	<q>{$data['title']}</q>
	<p class="pull-right"><a href="{$SCRIPT_NAME}?act=structure&part=edit&id={$data['sid']}" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o fa-fw"></i> Редактировать информацию</a></p>
</div>
