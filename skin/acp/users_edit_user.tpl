...
<form method="post" action="{$SCRIPT_NAME}?act=users&part=update_user&uid={$user['uid']}" enctype="multipart/form-data" role="form">
	<div class="card-body">
		...
		<div class="form-group row">
			<label for="inputNickname" class="col-md-4 form-control-plaintext text-right">
		...
		<div class="form-group row">
			<label for="inputLogin" class="col-md-4 form-control-plaintext text-right">
		...
		<div class="form-group row">
			<label for="inputPassword" class="col-md-4 form-control-plaintext text-right">
		...
		<div class="form-group row">
			<label for="inputEmail" class="col-md-4 form-control-plaintext text-right">
			...
			<div class="col-lg-8">
				<div class="btn-group btn-group-toggle roocms-boolui" data-toggle="buttons">
					<label class="btn btn-light{if $user['mailing'] == 1} active{/if}" for="flag_status_true" rel="tooltip" title="Получать рассылку" data-placement="auto" data-container="body">
						<input type="radio" name="mailing" value="1" id="flag_status_true"{if $user['mailing'] == 1} checked{/if}> <i class="far fa-fw fa-check-square"></i> <i class="fa fa-fw fa-envelope-open text-success"></i> Получать уведомления
					</label>
					<label class="btn btn-light{if $user['mailing'] == 0} active{/if}" for="flag_status_false" rel="tooltip" title="Не получать рассылку" data-placement="auto" data-container="body">
						<input type="radio" name="mailing" value="0" id="flag_status_false"{if $user['mailing'] == 0} checked{/if}> <i class="far fa-fw fa-square"></i> <i class="fa fa-fw fa-envelope text-danger"></i> Не получать уведомления
					</label>
				</div>
			</div>
		</div>
		...
		<div class="form-group row">
			<label for="inputUserName" class="col-md-4 form-control-plaintext text-right">
				Имя:
			</label>
			<div class="col-lg-8">
		...
		<div class="form-group row">
			<label for="inputUserSurName" class="col-md-4 form-control-plaintext text-right">
				Фамилия:
			</label>
			<div class="col-lg-8">
		...
		<div class="form-group row">
			<label for="inputUserLastName" class="col-md-4 form-control-plaintext text-right">
				Отчество:
			</label>
			<div class="col-lg-8">
		...
		<div class="form-group row">
			<label for="inputUserBirthdate" class="col-md-4 form-control-plaintext text-right">
				Дата рождения:
			</label>
			<div class="col-lg-8">
				<input type="text" name="user_birthdate" id="inputUserBirthdate" value="{if $user['user_birthdate'] != 0}{$user['user_birthdate']}{/if}" class="form-control datepicker w-50" data-date-end-date="-1y" data-date-start-view="2">
			</div>
		</div>

		<div class="form-group row">
			<label for="inputUserSlogan" class="col-md-4 form-control-plaintext text-right">
				Девиз:
			</label>
			<div class="col-lg-8">
		...
		<div class="form-group row">
			<label for="inputUserSex" class="col-md-4 form-control-plaintext text-right">
				Пол:
			</label>
			<div class="col-lg-8">
				<div class="btn-group btn-group-toggle roocms-boolui" data-toggle="buttons">
		...
		<div class="form-group row">
			<label for="inputAvatar" class="col-md-4 form-control-plaintext text-right">
		...
		{if !empty($groups)}
		<div class="form-group row">
			<label for="inputGroups" class="col-md-4 form-control-plaintext text-right">
