			...
			<div class="col-lg-6">
				<div class="card card-body h-100">
					...
					<div class="alert alert-warning border-warning text-center d-flex flex-column align-items-center h-100 mb-0" role="alert">
						...
						<span class="mb-auto">После регистрации Вам на почту придет письмо с просьбой подтвердить Ваши данные. Для заверешения регистрации, Вам будет необходимо перейти по ссылке из полученного письма. Подробная инструкция будет прилогаться.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-6">
							...
							<div class="row mb-3">
								<div class="col-sm-6 text-center d-flex flex-row justify-content-center align-items-center">
									...
									<div class="d-flex flex-column">
										...
										<a href="/captcha.php" class="badge badge-light ml-1 mt-1 zoom-CaptchaCode" tabindex="-1" data-fancybox="gallery_captcha" data-width="360" data-height="170"><i class="fas fa-fw fa-search-plus"></i></a>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
