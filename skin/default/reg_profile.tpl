		...
		<form method="post" action="{$SCRIPT_NAME}?part=reg&act=join" role="form" class="form-horizontal">
			...
			<div class="row">
				<div class="col-lg-8 col-md-offset-4">
					{if $config->fl152_use}
						<p class="small">Регистрируясь на сайте Вы соглашаетесь <nobr>с <a href="{$SCRIPT_NAME}?part=fl152&ajax=true" rel="html"><b>условиями передачи информации</b></a></nobr></p>
					{/if}
