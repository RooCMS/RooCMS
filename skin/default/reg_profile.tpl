		...
		<form method="post" action="{$SCRIPT_NAME}?part=reg&act=join" role="form" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-lg-8 col-md-offset-4">
					{if $config->fl152_use}
						<p class="small">Регистрируясь на сайте Вы соглашаетесь <span class="text-nowrap">с <a href="{$SCRIPT_NAME}?part=fl152&ajax=true" data-fancybox data-animation-duration="300" data-type="ajax"><b>условиями передачи информации</b></a></span></p>
					{/if}
