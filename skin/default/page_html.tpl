			...
			{if !empty($images)}
				<div class="d-flex flex-column flex-sm-row align-content-stretch justify-content-center flex-wrap">
					...
					{foreach from=$images item=img}
						<a href="/upload/images/{$img['resize']}" data-fancybox="gallery{$UGID}" data-animation-duration="300" data-caption="{$img['alt']}" title="{$img['alt']}" class="col-sm-4 col-lg-3 col-xl-2 px-1"><img src="/upload/images/{$img['thumb']}" alt="{$img['alt']}" class="w-100 img-fluid my-1"></a>
					{/foreach}
				</div>
			{/if}
